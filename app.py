...
<body>
    <div class="container">
        ...
        <p>Hi Paul, I use this website to communicate to my clients on Fiverr about going off platform so that we don't get into any trouble with Fiverr's guidelines. We technically aren't allowed to go off platform, but they can't scan the contents of this website so I can give you my contacts on here.</p>
        ...
        <div class="contact-box">
            ...
            <p>Message me on WhatsApp or through email and we can continue talking about the project without having to be careful about what we say.</p>
        </div>
